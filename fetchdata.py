...
# Futbol takımlarının fikstür bilgisi
    ...
    link = r"C:/Users/sedat/OneDrive/Masaüstü/softwareengineering/app/r.text"        
    with open(link, "w") as f:
        x = time.time()
        f.write(f"{x}")
             
    with open(r"C:/Users/sedat/OneDrive/Masaüstü/softwareengineering/app/register.json", 'w') as f:
...
def fetchMatchData(func1, func2):
    ...
    if (not os.path.isfile(r"C:/Users/sedat/OneDrive/Masaüstü/softwareengineering/app/r.text")):
        func1
        func2
    else:
        func2
...
def presentMatchData():
    ...
    for data in tabledata:
        data.insert(0, id)
        id += 1
    with open(r"C:/Users/sedat/OneDrive/Masaüstü/softwareengineering/app/register.json", 'r') as f:
        data = json.load(f)
        tabledata.insert(0, year+" : ")
        ...
        with open(r'C:/Users/sedat/OneDrive/Masaüstü/softwareengineering/app/r.text', 'w') as f:
            x = time.time()
            f.write(f"{x}")   
        with open(r"C:/Users/sedat/OneDrive/Masaüstü/softwareengineering/app/register.json", 'w') as f:
            json.dump(data, f)
...
def Weather():
    ...
    weatherList = []
    if os.path.isfile(r"C:/Users/sedat/OneDrive/Masaüstü/softwareengineering/app/weather.json"):
        with open(r'C:/Users/sedat/OneDrive/Masaüstü/softwareengineering/app/weather.json','r') as f:
            data = json.load(f)
            weatherList = []
            weatherList1 = data
            for city in cities:
            ...
            with open(r'C:/Users/sedat/OneDrive/Masaüstü/softwareengineering/app/weather.json', 'w') as f:
                json.dump(weatherList1, f)
            with open(r'C:/Users/sedat/OneDrive/Masaüstü/softwareengineering/app/r1.text', 'w') as f:
               x = time.time()
               f.write(f"{x}") 
    else:
        weatherList1 = []
...
def fetchBot():
    ...
    if (not os.path.isfile(r'C:/Users/sedat/OneDrive/Masaüstü/softwareengineering/app/r.text')):
        ...
        path = r'C:/Users/sedat/OneDrive/Masaüstü/softwareengineering/app/r.text'
        with open(path,"r",encoding="utf-8") as f:
            ...
            if (myRange >= 10800):
                fetchMatchData(getFirstFixture(), presentMatchData())
    if (not os.path.isfile(r"C:/Users/sedat/OneDrive/Masaüstü/softwareengineering/app/r1.text")):
        Weather()
    else:
        path =r"C:/Users/sedat/OneDrive/Masaüstü/softwareengineering/app/r1.text"
